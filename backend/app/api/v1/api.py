...
from app.api.v1.endpoints import auth, users, tweets, likes, retweets, websocket
...
api_router.include_router(websocket.router, prefix="/ws", tags=["websocket"])  # IMPORTANTE